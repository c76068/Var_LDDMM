function fshape = import_shape_obj(filename)
%IMPORT_OBJ(filename)
%
%this function imports a .obj file in fshape (3D triangle mesh only). The signal is set to zero. (This function uses a function written by A. Jacobson)
%
%Input :
...
%   fshape : struct('x',...,'G',...,'f',...)
%
% See also : import_fshape_ply, import_fshape_vtk
%

[fshape.x,fshape.G] = read_vertices_and_faces_from_obj_file(filename);
